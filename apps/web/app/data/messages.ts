export const messagePrefixes = [
  // EN - English (Dogs First)

  {
    label: 'EN - Challenging Dog',
  ...
  // DE - German (Dogs First)
  {
    label: 'DE - Herausfordernder Hund',
  ...
  {
    label: 'DE - Verspielte Katze gesucht',
